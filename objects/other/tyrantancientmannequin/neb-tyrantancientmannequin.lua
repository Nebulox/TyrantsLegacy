...
function init()
  ...
  storage.populated = storage.populated
end
...
function containerCallback()
  if not storage.populated then
    world.containerPutItemsAt(entity.id(), root.createItem("neb-tyrantshead", world.threatLevel()), 0)
    world.containerPutItemsAt(entity.id(), root.createItem("neb-tyrantschest", world.threatLevel()), 1)
    world.containerPutItemsAt(entity.id(), root.createItem("neb-tyrantslegs", world.threatLevel()), 2)
